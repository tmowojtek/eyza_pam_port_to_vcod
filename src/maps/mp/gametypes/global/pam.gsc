...
/*
		...
		// Errors
		maps\mp\gametypes\global\_global::precacheString2("STRING_PAM_DONT_STEAL", &"This version of pam is only for testing! Dont steal!");
		maps\mp\gametypes\global\_global::precacheString2("STRING_PAM_FS_GAME", &"Cvar /fs_game is not empty!)");
		maps\mp\gametypes\global\_global::precacheString2("STRING_PAM_MUST_EXISTS_UNDER_MAIN", &"Iwd file ^9zpam333.iwd^7 must be installed in ^9main^7 folder."); // ZPAM_RENAME
		maps\mp\gametypes\global\_global::precacheString2("STRING_PAM_GETTING_IWD_FILES_ERROR", &"Error while getting loaded iwd files. Make sure iwd files does not contains spaces.");
		maps\mp\gametypes\global\_global::precacheString2("STRING_PAM_MAPS_MISSING", &"Iwd file ^9zpam_maps_v3.iwd^7 does not exists in ^9main^7 folder");
		maps\mp\gametypes\global\_global::precacheString2("STRING_PAM_MAPS_LOAD_ERROR", &"Error while checking if fixed maps exists. Map printed above was not found on server.");
...
//--
	...
	fullNameArray = maps\mp\gametypes\global\_global::splitString(sv_referencedIwdNames, " ");
	...
	*/
	...
	/*
	// Convert iwd names to array
	numbersArray = maps\mp\gametypes\global\_global::splitString(sv_iwds, " ");
	nameArray = maps\mp\gametypes\global\_global::splitString(sv_iwdNames, " ");
...
arrayContains(array, content)
{
	for (i = 0; i < array.size; i++)
	{
		...
		if (maps\mp\gametypes\global\_global::toLower(array[i]) == maps\mp\gametypes\global\_global::toLower(content))
			return true;
	}
	return false;
}
...
//	logprint("PAM installation error: " + error + "\n");
	...
	bg = maps\mp\gametypes\global\_global::newHudElem2();
	...
	text1 = maps\mp\gametypes\global\_global::newHudElem2();
	text1.alignx = "center";
	text1.aligny = "top";
	text1.x = 320;
	text1.y = 200;
	...
	text2 = maps\mp\gametypes\global\_global::newHudElem2();
	text2.alignx = "center";
	text2.aligny = "top";
	text2.x = 320;
	text2.y = 225;
	...
	text3 = maps\mp\gametypes\global\_global::newHudElem2();
	text3.alignx = "center";
	text3.aligny = "top";
	text3.x = 320;
	text3.y = 255;
