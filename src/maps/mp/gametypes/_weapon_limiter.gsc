...
onWeaponChanged()
{
    for(;;)
    {
        ...
        self maps\mp\gametypes\global\_global::setClientCvarIfChanged(level.weapons[new_weapon].client_allowcvar, 3);
...
Update_Client_Weapon(player, weaponname, team)
{
	...
	if (cvarValue != -1)
	{
		player maps\mp\gametypes\global\_global::setClientCvarIfChanged(level.weapons[weaponname].client_allowcvar, cvarValue);
