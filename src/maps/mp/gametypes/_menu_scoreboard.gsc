...
onConnected()
{
	...
	if (level.gametype == "sd")
		...
		self maps\mp\gametypes\global\_global::setClientCvar2("ui_scoreboard_show", "");
...
addPlayerLine(team, stats)
{
	...
	{
		name = maps\mp\gametypes\global\_global::removeColorsFromString(name); // remove colors
