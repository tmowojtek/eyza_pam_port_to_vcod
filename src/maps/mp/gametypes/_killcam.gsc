...
killcam(attackerNum, pastTime, length, offsetTime, respawn, isReplay)
{
	...
	{
		self.kc_topbar = maps\mp\gametypes\global\_global::newClientHudElem2(self);
	...
	{
		self.kc_bottombar = maps\mp\gametypes\global\_global::newClientHudElem2(self);
	...
	{
		self.kc_title = maps\mp\gametypes\global\_global::newClientHudElem2(self);
	...
	if (isReplay)
	{
		...
		{
			player = maps\mp\gametypes\global\_global::GetEntityByClientId(attackerNum);
			if (isDefined(player))
			{
				self.kc_playername = maps\mp\gametypes\global\_global::newClientHudElem2(self);
				self.kc_playername.archived = false;
				//self.kc_playername.x = 0;
				self.kc_playername.x = 320;
	...
	{
		self.kc_skiptext = maps\mp\gametypes\global\_global::newClientHudElem2(self);
	...
	{
		self.kc_timer = maps\mp\gametypes\global\_global::newClientHudElem2(self);
