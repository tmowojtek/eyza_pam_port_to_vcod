...
hide_matchinfo()
{
	self maps\mp\gametypes\global\_global::setClientCvarIfChanged("ui_streamersystem_matchinfo", "");
}
...
*/
		...
		self maps\mp\gametypes\global\_global::setClientCvarIfChanged("ui_streamersystem_matchInfo", matchInfo);
