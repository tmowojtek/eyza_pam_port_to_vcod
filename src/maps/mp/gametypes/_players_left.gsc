...
updateEnemyList()
{
	...
	//if (self.pers["team"] == "allies" || self.pers["team"] == "axis" || self.pers)
	if (isDefined(self.pers) && (self.pers["team"] == "allies" || self.pers["team"] == "axis"))
	{
		...
		for(i = 0; i < playerList.size; i++)
		{
			...
			name += maps\mp\gametypes\global\_global::removeColorsFromString(playerList[i].name);
			//logprint("_players_left:: name=" + name + "\n");
			...
			//logprint("_players_left:: removed leading spaces name=" + name + "\n");
		...
		//logprint("_players_left:: maxSize=" + maxSize + "\n");
		for(i = 0; i < nameList.size; i++)
		{
	...
	//logprint("_players_left:: ui_playersleft_list=" + str + "\n");
	self maps\mp\gametypes\global\_global::setClientCvarIfChanged("ui_playersleft_list", str);
}