...
{
	// Match Style
	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_dm_timelimit", 0);		// Time limit. When halftime is enabled, its time limit per half. 0=disabled (minutes)
	...
	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_dm_end_score", 0);		// Number of score when map ends. 0=ignored
	...
	*******************************/
	...
	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_readyup_nadetraining", 0); 	// Enable strat grenade fly mode in readyup
	...
	// Time-out
	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_timeouts", 0);						// Total timeouts for one team
	...
	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_friendlyfire", 0);
	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_drawfriend", 0);
	...
	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "g_maxDroppedWeapons", 10);
