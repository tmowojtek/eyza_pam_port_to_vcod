...
Load()
{
	...
	game["rules_formatString"] = &"30 min"; // default
...
GetCvars(arr)
{
	...
	*******************************/
	...
	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_readyup_start_timer", 5); 	// Count-down timer with black screen when all players are ready
