...
{
	// Match Style
	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_dm_timelimit", 60);		// Time limit. When halftime is enabled, its time limit per half. 0=disabled (minutes)
