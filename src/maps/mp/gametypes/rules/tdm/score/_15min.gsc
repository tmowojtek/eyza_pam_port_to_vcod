...
{
	// Match Style
	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_tdm_timelimit", 7.5);		// Time limit. When halftime is enabled, its time limit per half. 0=disabled (minutes)
