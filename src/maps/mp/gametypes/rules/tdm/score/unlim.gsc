...
{
	// Match Style
	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_tdm_timelimit", 0);		// Time limit. When halftime is enabled, its time limit per half. 0=disabled (minutes)
	...
	// Halftime
	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_tdm_halftime", 0);			// Do halftime. When 1, scr_tdm_timelimit means time per half
