...
GetCvars(arr)
{
	...
	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_spectatefree", 1);
	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_spectateenemy", 1);
	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_streamersystem", 0);				// Enable streamer system (menu overlay with auto-killcam, auto-spectator, xray, etc.. features)
	...
	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "sv_floodprotect", 0);		// 0 - allow spaming from basic client commands - /say, /noclip;  1 - add 1 second delay between commands
	...
	*********/
	...
	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_boltaction_nades", 99);
	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_semiautomatic_nades", 99);
	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_smg_nades", 99);
	...
	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_semiautomatic_smokes", 99);
	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_smg_smokes", 99);
	...
	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_sniper_limit", 99);
	...
	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_semiautomatic_allow_drop", 0);
	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_smg_allow_drop", 0);
	...
	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_allow_secondary_drop", 0);
