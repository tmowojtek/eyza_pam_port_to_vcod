...
main()
{
	...
	[[varRCEx]]("C", "scr_dm_timelimit", "FLOAT", 0, 0, 99999);
	[[varRCEx]]("C", "scr_dm_half_score", "INT", 0, 0, 99999);
	[[varRCEx]]("C", "scr_dm_end_score", "INT", 0, 0, 99999);
	[[varRCEx]]("C", "scr_dm_halftime", "BOOL", 1);
	[[varRC]]("scr_dm_strat_time", "FLOAT", 5, 0, 15);	// Time before round starts (sec) (0 - 10, default 5)
...
onCvarChanged(cvar, value, isRegisterTime)
{
	...
	switch(cvar)
	{
		...
		case "scr_dm_strat_time": 	level.strat_time = value; 	return true;
	}
	return false;
}
...
HUD_StratTime(time)
{
	...
	strattime maps\mp\gametypes\global\_global::destroy2();
	strat_clock maps\mp\gametypes\global\_global::destroy2();
}
